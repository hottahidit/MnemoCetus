...
* Detect project types (Python, Node.js, Rust, etc.)
...
As of now, the basic functions of this tool are being made. Version 1 will release with no AI integration, and after that will this tool be built upon.
...
DISCLAIMER: As of v0.1, these are all the available features, and how to use them.
